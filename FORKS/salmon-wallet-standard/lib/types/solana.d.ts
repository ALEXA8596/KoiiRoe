...
export declare const SOLANA_CHAINS: readonly ["solana:mainnet", "solana:devnet", "solana:testnet"];
 ...
 */
export declare function getNetworkForChain(chain: SolanaChain): string;
